...
namespace Snap
{
    partial class About
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.MediaMonkey = new System.Windows.Forms.Timer(this.components);
            this.AIMP = new System.Windows.Forms.Timer(this.components);
            this.QuodLibet = new System.Windows.Forms.Timer(this.components);
    ...
    " button below.";
            ...
            // MediaMonkey
            // 
            this.MediaMonkey.Tick += new System.EventHandler(this.MediaMonkey_Tick);
            // 
            // AIMP
            // 
            this.AIMP.Tick += new System.EventHandler(this.AIMP_Tick);
            // 
            // QuodLibet
            // 
            this.QuodLibet.Tick += new System.EventHandler(this.QuodLibet_Tick);
            // 
            // About
            // 
        ...
        private System.Windows.Forms.Timer MediaMonkey;
        private System.Windows.Forms.Timer AIMP;
        private System.Windows.Forms.Timer QuodLibet;
    }
}
